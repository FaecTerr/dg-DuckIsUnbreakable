...
namespace DuckGame.DuckUnbreakable
{
    ...
    public class BluePort : Thing
    {
        ...
        public BluePort(float xpos, float ypos, YDoor ydor) : base(xpos, ypos)
        {
            _sprite = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Things/KCDoors/CardPortBlue.png"), 16, 16, false);
            graphic = _sprite;
        ...
        {
            base.Update();
            BlueKC ykc = Level.CheckCircle<BlueKC>(base.x, base.y, 4f);
            if (ykc != null)
            {
                getOpen = true;
                _sprite.frame = 1;
