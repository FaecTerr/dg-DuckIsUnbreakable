...
namespace DuckGame.DuckUnbreakable
{
    ...
    public class RedPort : Thing
    {
        ...
        public RedPort(float xpos, float ypos, YDoor ydor) : base(xpos, ypos)
        {
            _sprite = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Things/KCDoors/CardPortRed.png"), 16, 16, false);
            graphic = _sprite;
        ...
        {
            base.Update();
            RedKC ykc = Level.CheckCircle<RedKC>(base.x, base.y, 4f);
            if (ykc != null)
            {
                getOpen = true;
                _sprite.frame = 1;
