...
{
    public class TrashParticles : PhysicsObject
    {
        protected SpriteMap _sprite;
        private float randomSpin = Rando.Float(0.3f);

        public TrashParticles(float xpos, float ypos) : base(xpos, ypos)
        {
            _sprite = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Things/Decorative/TrashParts.png"), 7, 7, false);
