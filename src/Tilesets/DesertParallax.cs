...
namespace DuckGame.DuckUnbreakable
{
    ...
    public class DesertParallax : BackgroundUpdater
    {
        ...
        {
            graphic = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Desert/DesertIcon"), 16, 16, false);
        ...
        public override void Initialize()
        {
            ...
            _parallax = new ParallaxBackground(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Desert/desert_.png"), 0f, 0f, 3);
            float speed = 0.4f;
