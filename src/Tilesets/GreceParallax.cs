...
namespace DuckGame.DuckUnbreakable
{
    ...
    public class GreceParallax : BackgroundUpdater
    {
        public GreceParallax(float xpos, float ypos) : base(xpos, ypos)
        {
            graphic = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Greek/GreceIcon"), 16, 16, false);
        ...
        public override void Initialize()
        {
            ...
            _parallax = new ParallaxBackground(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Greek/Greek.png"), 0f, 0f, 3);
            float speed = 0.4f;
