...
{
    [EditorGroup("Faecterr's|Tiles|Paralax")]
    public class CaveParallax : BackgroundUpdater
    {
        public CaveParallax(float xpos, float ypos) : base(xpos, ypos)
        {
            graphic = new SpriteMap(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Cave/CaveIcon"), 16, 16, false);
        ...
        public override void Initialize()
        {
            ...
            _parallax = new ParallaxBackground(Mod.GetPath<DuckUnbreakable>("Sprites/Tilesets/Cave/Cave.png"), 0f, 0f, 3);
            float speed = 0.4f;
